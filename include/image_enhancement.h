...
void Ying_2017_CAIP(const cv::Mat& src, cv::Mat& dst, double mu = 0.5, double a = -0.3293, double b = 1.1258, double lambda = 0.5, double sigma = 5)
{
    ...
    // end_time = clock();
    // std::cout << "computeTextureWeight处理时间: " << (double)(end_time - start_time) / CLOCKS_PER_SEC << "s" << std::endl;
    ...
    cv::Mat normalized_T;
    {
        ...
        // end_time = clock();
        // std::cout << "Before Ax=b处理时间: " << (double)(end_time - start_time) / CLOCKS_PER_SEC << "s" << std::endl;
        ...
        // end_time = clock();
        // std::cout << "Ax=b处理时间: " << (double)(end_time - start_time) / CLOCKS_PER_SEC << "s" << std::endl;
    }
    ...
    // end_time = clock();
    // std::cout << "J处理时间: " << (double)(end_time - start_time) / CLOCKS_PER_SEC << "s" << std::endl;
